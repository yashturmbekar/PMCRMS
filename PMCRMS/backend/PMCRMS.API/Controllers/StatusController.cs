    ...
    public class StatusController : ControllerBase
    {
        ...
        private WorkflowDto GetWorkflowSteps(ApplicationType applicationType)
        {
            ...
            var steps = new List<WorkflowStepDto>
            {
                ...
                new() { Step = 9, Status = "UnderReviewByCE1", Description = "Under review by Chief Engineer", Role = "CityEngineer" },
                new() { Step = 10, Status = "ApprovedByCE1", Description = "Approved by Chief Engineer", Role = "CityEngineer" },
